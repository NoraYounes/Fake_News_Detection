...
1. **Slack**: the primary channel for messaging during meetings and is used to share resources/project files
2. **Zoom**: the video conferencing platform used for team meetings
3. **Google Docs**: is used to document meeting notes and project planning elements
4. **Whatsapp**: an alternative channel used to schedule team meetings and is used for messaging when the team is offlin
